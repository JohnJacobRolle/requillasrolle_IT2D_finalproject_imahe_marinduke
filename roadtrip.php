...
<body>
    ...
    <div class="tm-hero d-flex justify-content-center align-items-center" data-parallax="scroll" data-image-src="img/roadfront.jpg"></div>

    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">Dampulan Road</h2>
        </div>
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
                <a href="img/road/dampulan.jpg"><img src="img/road/dampulan.jpg" alt="Image" class="img-fluid"></a>
            </div>
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    <p class="mb-4">
                         If you want to go out and have a stroll with your friends, love once, or families this is one of the best spot you can go.
                    </p>          
                    <p>
                    ...
                    <div class="mb-4">
                        ...
                        <p>Location: Seawall Dampulan, Torrijos, Marinduqe</p>
                        <p>Photo Credit: Mariones Padyak Khaki Bikers</p>
                    </div>
