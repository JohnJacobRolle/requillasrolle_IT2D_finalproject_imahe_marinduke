...
<body>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">Dayo</h2>
        </div>
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
                <a href="img/restaurant/dayoresto.jpg"><img src="img/restaurant/dayoresto.jpg" alt="Image" class="img-fluid"></a>
            </div>
        ...
        <div class="row mb-3 tm-gallery">
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <figure class="effect-ming tm-video-item">
                    <a href="img/restaurant/dayoresto1.jpg"><img src="img/restaurant/dayoresto1.jpg" alt="Image" class="img-fluid"></a>                 
                </figure>
