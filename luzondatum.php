...
<body>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">Luzon Datum</h2>
        </div>
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
                <a href="img/freshair/luzondatum.jpg"><img src="img/freshair/luzondatum.jpg" alt="Image" class="img-fluid"></a>
            </div>
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    ...
                    <p class="mb-4">
                         Some adventure and you love mother earth nature? this one is the best for you. Stroll? this is the best destination for you.
                    </p>          
                    <p>
                    ...
                    <div class="mb-4">
                        ...
                        <p>Location: Guisian, Mogpog, Marinduqe</p>
        ...
        <div class="row mb-3 tm-gallery">
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <figure class="effect-ming tm-video-item">
                    <a href="img/freshair/luzondatum1.jpg"><img src="img/freshair/luzondatum1.jpg" alt="Image" class="img-fluid"></a>                 
                </figure>
